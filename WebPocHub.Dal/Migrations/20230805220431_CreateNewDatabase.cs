        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SeatFilled = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.InsertData(
                table: "Employees",
                columns: new[] { "EmplyeeId", "Address", "Avatar", "City", "Country", "Email", "EmployeeName", "Phone", "Skillsets", "ZipCode" },
                values: new object[,]
                {
                    { 1, "Vojvode Momcila 123", "/images/igor.png", "Banja Luka", "Bosnia and Herzegovina", "igor@email.com", "Igor Rodic", "065787945", "DBA", "78000" },
                    { 2, "Stepe Stepanovica 132", "/images/nina.png", "Banja Luka", "Bosnia and Herzegovina", "nina@email.com", "Nina Rodic", "065123123", "People Managment", "78000" },
                    { 3, "Zivojina Misica 231", "/images/pero.png", "Belgrade", "Serbia", "pero@email.com", "Pero Peric", "063123451", "Consultant", "11000" }
                });
